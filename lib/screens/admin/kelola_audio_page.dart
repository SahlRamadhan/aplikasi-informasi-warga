...
class KelolaAudioPage extends StatelessWidget {
  final String collectionName = 'audio_komunitas';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Kelola Audio")),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  KelolaMediaForm(collectionName: collectionName),
            ),
          );
        },
      ),
